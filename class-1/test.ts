...
const alertts:string = "Hello Type-Script here !"

alert(alertts);

const msg:string = "Good Morning!"; // we set the type of msg is srting // we dont pass number in this variable //

alert(msg)

const num:number = 123; //we set the alert type is number //
alert(num)

function table(numb:number) { //type of numb parametter is number he will recive only number value //
    for (let i = 1; i <= 2; i++) {
